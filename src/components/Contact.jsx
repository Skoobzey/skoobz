    ...
    <section id="contact" className="py-24">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-gradient-to-br from-accent/10 to-transparent border border-black/5 dark:border-white/5 rounded-3xl p-10 sm:p-16 text-center">
          ...
          <a
            href="https://discord.com/users/410998895422865408"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-accent hover:bg-accent-dark text-white font-semibold text-lg transition-colors"
          >
            Message on Discord
